...
class SessionController
{
    ...
    public function setCookie(string $coockie_email){
        ...
        SELECT "user_name", "name", "surname" FROM "users" JOIN public."users_details" ON users.id = "users_details".id WHERE "email" = :email
        ');
        ...
        setcookie('user', json_encode(['user_name' => $respond['user_name'], 'email' => $coockie_email,'name' => $respond['name'], 'surname'=>$respond['surname'], 'code' => $randomString]), $expired, '/');
